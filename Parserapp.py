...
"")
        ...
        self.logo.setText("")
        self.logo.setPixmap(QtGui.QPixmap(f"{os.getcwd()}/logo/икно.png"))
        ...
        self.iconBrouser.setPixmap(QtGui.QPixmap(f"{os.getcwd()}/logo/браузер.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Парсер картинок из интернета"))
